...
(function (sugarLab) {
    ...
    sugarLab.Vec2 = function (x, y) {
        ...
        me.angleBetween = function (p2) {
            return (Math.atan2(me.y - p2.y, me.x - p2.x) * 180 / Math.PI);
        };
    };
    ...
    sugarLab.Vec2.fromPolar = function (magnitude, angle) {
        return new sugarLab.Vec2(magnitude * Math.cos(angle * TO_RADIANS), magnitude * Math.sin(angle * TO_RADIANS));
    };
    ...
    sugarLab.drawText = function (text, location, color, font, sctx) {
        sctx.save();
        sctx.font = font;
        sctx.fillStyle = color;
    ...
    sugarLab.drawLine = function (Line, color, sctx) {
        sctx.save();
        sctx.strokeStyle = color;
        sctx.lineWidth = 2;
        sctx.beginPath();
